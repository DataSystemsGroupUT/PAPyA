...
abstract class PropertyTableLoader extends Loader {
	...
	Dataset<Row> createPropertyTableDataset(final Map<String, Boolean> propertiesCardinalities,
		...
		//Add the subject as the first col in the WPT
...
//		String[] x = propertiesList.toArray(new String[0]);
//		System.out.println(Arrays.toString(x));


		Dataset wpt =grouped.selectExpr(propertiesList.toArray(new String[0]));
